...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white text-gray-900 shadow-sm border-gray-200 border-b transition-colors duration-200 lg:pl-26 sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-around h-26 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            >
              Strona główna
              <span className={`absolute bottom-0 left-1/2 w-0 h-0.5 bg-yellow-600 transition-all duration-300 transform -translate-x-1/2 ${
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            {/* Wishlist */}
            <button className="p-2 rounded-full transition-colors text-gray-400 hover:text-gray-500 hover:bg-gray-100">
