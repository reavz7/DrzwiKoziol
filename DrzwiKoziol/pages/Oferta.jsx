...
function Oferta() {
  const katalogi = [
    ...
    },
    {
      ...
      pdfUrl:
        "/Barański Drzwi - Katalog Drzwi Zewnętrznych Premium 2025 - edycja 1 - 2025.04.22.pdf",
    },
    {
      id: 3,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-medium">
            Odkryj katalogi naszych partnerskich firm. Przejrzyj dowolny katalog
            PDF
          </p>
        </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="aspect-[4/3] overflow-hidden bg-gray-100">
                  <img
                    src={
                      katalog.obrazUrl ||
                      "/placeholder.svg?height=300&width=400&query=modern door design"
                    }
        ...
        <div className="text-center mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/kontakt"
              className="bg-black text-white px-8 py-4 cursor-pointer font-bold text-lg hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center gap-2"
            >
              SKONTAKTUJ SIĘ
              <svg
                className="w-5 h-5"
            ...
            <Link
              to="/realizacje"
              className="border-2 border-black cursor-pointer text-black px-8 py-4 font-bold text-lg hover:bg-black hover:text-white transition-all duration-200 flex items-center justify-center gap-2"
            >
              REALIZACJE
              <svg
                className="w-5 h-5"
